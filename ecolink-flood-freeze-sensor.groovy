metadata {
	definition (name: "Jasco Smart Flood/Freeze Sensor", namespace: "Boyer", author: "Boyer", ocfDeviceType: "x.com.st.d.sensor.water") {
		...
		fingerprint  mfr: "0063", prod: "4953", model: "3231"
}
	...
	simulator {
		...
		status "dry notification": "command: 7105, payload: 00"
    ...
    standardTile("shockSensor","device.shockSensor", decoration: "flat", width: 2, height: 2) {
      ...
      state("detected", label:'Tamper', action: "clearShock", icon:"st.contact.contact.open", backgroundColor:"#e86d13")
    }	
