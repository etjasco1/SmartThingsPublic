metadata {
	definition (
		name: "Jasco Smart Window/Door Sensor FINAL", 
		namespace: "Boyer Simpkins", 
		author: "Boyer Simpkins"
	) {
		capability "Sensor"
		...
		fingerprint mfr: "0063", prod: "4953", model: "3139", deviceJoinName: "Jasco Smart Door/Window Sensor"
	}
	...
	preferences {
		...
		input "enableExternalSensor", "bool", 
			...
			description: "The Door/Window Sensor includes terminals that allow you to attach an external sensor.",
			defaultValue: false,
			displayDuringSetup: true, 
			required: false
